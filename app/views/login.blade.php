...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <img src="img/background.jpg" alt="Login Full Background" class="full-bg animation-pulseSlow">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="text" id="username" name="username" class="form-control input-lg" placeholder="Nombre de Usuario">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="password" id="password" name="password" class="form-control input-lg" placeholder="Constraseña">
                            </div>
                        </div>
                    </div>
